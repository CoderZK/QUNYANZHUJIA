...
- (void)viewDidLoad {
    ...
    // 默认的外观，你可以在这个方法后重置
    self.oKButtonTitleColorNormal   = [UIColor colorWithRed:(255/255.0) green:(114/255.0) blue:(49/255.0) alpha:1.0];
    self.oKButtonTitleColorDisabled = [UIColor colorWithRed:(255/255.0) green:(114/255.0) blue:(49/255.0) alpha:0.5];
...
- (void)configDefaultSetting {
    ...
    self.iconThemeColor = [UIColor colorWithRed:(255/255.0) green:(114/255.0) blue:(49/255.0) alpha:1.0]; //[UIColor colorWithRed:31 / 255.0 green:185 / 255.0 blue:34 / 255.0 alpha:1.0];

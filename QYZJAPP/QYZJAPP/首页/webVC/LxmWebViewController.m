...
- (void)viewDidLoad {
    ...
    _wkWebView=[[WKWebView alloc] initWithFrame:CGRectMake(0, 0.5, self.view.bounds.size.width , self.view.bounds.size.height)];
    ...
    //修改进度条颜色
    _progress.progressTintColor = OrangeColor;
    if (_loadUrl) {
        if (_postParames) {
